...
namespace ActiveRagdoll {
    ...
    public class MovementModule : Module {
        ...
        private void UpdateIK() {
            ...
            Vector3 bodyForward = _activeRagdoll.AnimatedTorso.forward;
            Vector3 bodyRight = _activeRagdoll.AnimatedTorso.right;
            Quaternion bodyRot = _activeRagdoll.PhysicalTorso.rotation;
            ...
            float camVerticalPercent = 1 - Mathf.Clamp01((cameraAngle - minCameraAngle) / Mathf.Abs(maxCameraAngle - minCameraAngle));
            ...
            float lookVerticalAngle = camVerticalPercent * Mathf.Abs(maxLookAngle - minLookAngle) + minLookAngle;
            float armsVerticalAngle = camVerticalPercent * Mathf.Abs(maxArmsAngle - minArmsAngle) + minArmsAngle;
            ...
            float currentArmsDistance = armsDistance.Evaluate(camVerticalPercent);
