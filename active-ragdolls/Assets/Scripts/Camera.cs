...
namespace ActiveRagdoll {
    ...
    public class Camera : MonoBehaviour {
        ...
        [SerializeField] private float _maxDistance = 5f, _defaultDistance = 2.5f;
        ...
        void Update() {
            ...
            if (_improveSteepInclinations) {
                ...
                movedLookPoint += (Quaternion.Euler(_inclinationAngle, 0, 0) * Auxiliary.GetFloorProjection(transform.forward)) * currentDistance;
            }
            ...
            RaycastHit hitInfo;
            bool hit = Physics.Raycast(cameraRay, out hitInfo, Vector3.Distance(transform.position, _lookPoint.position), ~_dontBlockCamera);
