...
3. Update the README.md and/or documentation of the project with details of changes to the interface,
   this includes new environment variables, exposed ports, useful file locations and container parameters.
4. Increase the version numbers in any examples files and the README.md and/or documentation to the new version that this
   Pull Request would represent. The versioning scheme we use is [SemVer](http://semver.org/).
5. Make sure your pull request title and description are clear and concise about what your changes
   are fixing or implementing.
